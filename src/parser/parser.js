...
(function (root, factory) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
      ...
      peg$c243 = function (id) {
        return [id];
      },
      peg$c244 = function (value) {
        return {
          type: "Literal",
          value: value,
        };
      ...
      peg$c362 = function (body, test) {
        return { type: "DoWhileStatement", body: body, test: test };
      },
      peg$c363 = function (test, body) {
