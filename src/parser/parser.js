...
(function(root, factory) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c251 = function(head, args) {
                  return { type: "CallExpression", arguments: args };
                },
        peg$c252 = function(head, property) {
                  return {
                    type: "MemberExpression",
                    property: property,
                    computed: true
        ...
        peg$c255 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c256 = function(identifier, argument) {
            return {
                ...argument,
        ...
        peg$c260 = function(identifier) {return identifier},
        peg$c261 = function(argument, operator) {
              return {
        ...
        peg$c266 = function(operator, argument) {
        ...
        peg$c275 = function(head, tail) { return buildBinaryExpression(head, tail); },
        peg$c276 = "*",
        ...
        peg$c320 = function(head, tail) { return buildLogicalExpression(head, tail); },
        peg$c321 = "&&",
        ...
        peg$c362 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test }; },
        peg$c363 = function(test, body) { return { type: "WhileStatement", test: test, body: body }; },
        ...
        peg$c365 = function(declarations, test, update, body) {
              return {
                type: "ForStatement",
                init: {
                  type: "VariableDeclaration",
        ...
        peg$c366 = function(left, right, body) {
              return {
                type: "ForInStatement",
                left: left,
                right: right,
        ...
        peg$c367 = function(declarations, right, body) {
              return {
                type: "ForInStatement",
                left: {
                  type: "VariableDeclaration",
        ...
        peg$c373 = function(argument) {
              return { type: "ReturnStatement", argument: argument };
            },
        peg$c374 = function(object, body) { return { type: "WithStatement", object: object, body: body }; },
        peg$c375 = function(clauses) {
              return optionalList(extractOptional(clauses, 0));
            },
        peg$c376 = function(before, default_, after) {
              return optionalList(extractOptional(before, 0))
                .concat(default_)
                .concat(optionalList(extractOptional(after, 0)));
            },
        peg$c377 = function(test, consequent) {
              return {
                type: "SwitchCase",
                test: test,
        ...
        peg$c380 = function(argument) {
              return { type: "ThrowStatement", argument: argument };
            },
        peg$c381 = function(block, handler, finalizer) {
              return {
                type: "TryStatement",
                block: block,
                handler: handler,
        ...
        peg$c382 = function(block, handler) {
              return {
                type: "TryStatement",
                block: block,
                handler: handler,
        ...
        peg$c383 = function(block, finalizer) {
              return {
                type: "TryStatement",
                block: block,
                handler: null,
        ...
        peg$c385 = function(block) { return block; },
        peg$c386 = function() { return { type: "DebuggerStatement" }; },
        peg$c387 = function(id, params, body) {
              return {
